...
public class Thursday extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noTimetable.setText(getString(R.string.no_timetable_string)+"Thursday");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new ClickListener() {
            ...
            public void onLongClick(View view, int position) {
                ...
                deleteSubjectTimetable(timetable.getName(), "thursday");
            }
        }));
    ...
    public void getSubjects(){
        workshopList = timetableDB.getAllTimeTable("thursday");
        if(workshopList.size()==0)
            noTimetable.setVisibility(View.VISIBLE);
        else
            noTimetable.setVisibility(View.GONE);
        mAdapter= new TimetableAdapter(workshopList,this.getContext(),recyclerView,"thursday");
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private Thursday.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Thursday.ClickListener clickListener) {
