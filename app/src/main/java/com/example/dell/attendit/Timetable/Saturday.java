...
public class Saturday extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noTimetable.setText(getString(R.string.no_timetable_string)+"Saturday");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new ClickListener() {
            ...
            public void onLongClick(View view, int position) {
                ...
                deleteSubjectTimetable(timetable.getName(), "saturday");
            }
        }));
    ...
    public void getSubjects(){
        workshopList = timetableDB.getAllTimeTable("saturday");
        if(workshopList.size()==0)
            noTimetable.setVisibility(View.VISIBLE);
        else
            noTimetable.setVisibility(View.GONE);
        mAdapter= new TimetableAdapter(workshopList,this.getContext(),recyclerView,"saturday");
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private Saturday.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Saturday.ClickListener clickListener) {
