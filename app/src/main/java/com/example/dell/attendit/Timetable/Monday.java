...
public class Monday extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noTimetable.setText(getString(R.string.no_timetable_string)+ "Monday");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new ClickListener() {
            ...
            public void onLongClick(View view, int position) {
                ...
                deleteTimetable(timetable.getName(),"monday");
            }
        }));
    ...
    public void getSubjects(){
        workshopList = timetableDB.getAllTimeTable("monday");
        if(workshopList.size()==0)
            noTimetable.setVisibility(View.VISIBLE);
        else
            noTimetable.setVisibility(View.GONE);
        mAdapter= new TimetableAdapter(workshopList,this.getContext(),recyclerView,"monday");
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private Monday.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Monday.ClickListener clickListener) {
