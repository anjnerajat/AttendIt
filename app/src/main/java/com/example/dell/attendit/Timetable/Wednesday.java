...
public class Wednesday extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noTimetable.setText(getString(R.string.no_timetable_string)+"Wednesday");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new ClickListener() {
            ...
            public void onLongClick(View view, int position) {
                ...
                deleteSubjectTimetable(timetable.getName(), "wednesday");
            }
        }));
    ...
    public void getSubjects(){
        workshopList = timetableDB.getAllTimeTable("wednesday");
        if(workshopList.size()==0)
            noTimetable.setVisibility(View.VISIBLE);
        else
            noTimetable.setVisibility(View.GONE);
        mAdapter= new TimetableAdapter(workshopList,this.getContext(),recyclerView,"wednesday");
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private Wednesday.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Wednesday.ClickListener clickListener) {
