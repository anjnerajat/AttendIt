...
public class Sunday extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noTimetable.setText(getString(R.string.no_timetable_string)+ "Sunday");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new ClickListener() {
            ...
            public void onLongClick(View view, int position) {
                ...
                deleteSubjectTimetable(timetable.getName(), "sunday");
            }
        }));
    ...
    public void getSubjects(){
        workshopList = timetableDB.getAllTimeTable("sunday");
        if(workshopList.size()==0)
            noTimetable.setVisibility(View.VISIBLE);
        else
            noTimetable.setVisibility(View.GONE);
        mAdapter= new TimetableAdapter(workshopList,this.getContext(),recyclerView,"sunday");
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private Sunday.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Sunday.ClickListener clickListener) {
